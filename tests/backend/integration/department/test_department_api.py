...
def isolated_test_db():
    ...
    # Session factory for this test DB
    TestSessionLocal = sessionmaker(bind=test_engine)

    # Patch the department service's SessionLocal to use our test DB
...
# INT-002/001 — HR can create a department and then view it
...
# INT-002/002 — Validation errors: bad inputs (HR role present)

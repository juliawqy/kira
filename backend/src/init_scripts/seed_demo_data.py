...
def seed_database():
   ...
   # Create Developers team and Support team under System Solutioning Department
    ...
    call_centre_create = [
        {"name": "Adeline Goh", "email": "adeline.goh.eod@kira.ai", "password": "Password123!", "role": UserRole.STAFF, "admin": False, "department_id": departments[3]['department_id']},
        {"name": "Adib Bin Hassan", "email": "adib.hassan.eod@kira.ai", "password": "Password123!", "role": UserRole.STAFF, "admin": False, "department_id": departments[3]['department_id']},
        {"name": "Aditya Kumar", "email": "aditya.kumar.eod@kira.ai", "password": "Password123!", "role": UserRole.STAFF, "admin": False, "department_id": departments[3]['department_id']},
        {"name": "Adrian Lim", "email": "adrian.lim.eod@kira.ai", "password": "Password123!", "role": UserRole.STAFF, "admin": False, "department_id": departments[3]['department_id']},
        {"name": "Afiqah Noor", "email": "afiqah.noor.eod@kira.ai", "password": "Password123!", "role": UserRole.STAFF, "admin": False, "department_id": departments[3]['department_id']},
        {"name": "Aileen Ng", "email": "aileen.ng.eod@kira.ai", "password": "Password123!", "role": UserRole.STAFF, "admin": False, "department_id": departments[3]['department_id']},
        {"name": "Ajay Nair", "email": "ajay.nair.eod@kira.ai", "password": "Password123!", "role": UserRole.STAFF, "admin": False, "department_id": departments[3]['department_id']},
        {"name": "Alfred Tan", "email": "alfred.tan.eod@kira.ai", "password": "Password123!", "role": UserRole.STAFF, "admin": False, "department_id": departments[3]['department_id']},
        {"name": "Aliyah Binte Rahman", "email": "aliyah.rahman.eod@kira.ai", "password": "Password123!", "role": UserRole.STAFF, "admin": False, "department_id": departments[3]['department_id']},
        {"name": "Amanda Koh", "email": "amanda.koh.eod@kira.ai", "password": "Password123!", "role": UserRole.STAFF, "admin": False, "department_id": departments[3]['department_id']},
        {"name": "Amirah Abdullah", "email": "amirah.abdullah.eod@kira.ai", "password": "Password123!", "role": UserRole.STAFF, "admin": False, "department_id": departments[3]['department_id']},
        {"name": "Amrit Kaur", "email": "amrit.kaur.eod@kira.ai", "password": "Password123!", "role": UserRole.STAFF, "admin": False, "department_id": departments[3]['department_id']},
        {"name": "Andrea Lee", "email": "andrea.lee.eod@kira.ai", "password": "Password123!", "role": UserRole.STAFF, "admin": False, "department_id": departments[3]['department_id']},
        {"name": "Angela Yeo", "email": "angela.yeo.eod@kira.ai", "password": "Password123!", "role": UserRole.STAFF, "admin": False, "department_id": departments[3]['department_id']},
        {"name": "Anil Raj", "email": "anil.raj.eod@kira.ai", "password": "Password123!", "role": UserRole.STAFF, "admin": False, "department_id": departments[3]['department_id']},
        {"name": "Anisa Binte Omar", "email": "anisa.omar.eod@kira.ai", "password": "Password123!", "role": UserRole.STAFF, "admin": False, "department_id": departments[3]['department_id']},
        {"name": "Anita Devi", "email": "anita.devi.eod@kira.ai", "password": "Password123!", "role": UserRole.STAFF, "admin": False, "department_id": departments[3]['department_id']},
        {"name": "Annabelle Tan", "email": "annabelle.tan.eod@kira.ai", "password": "Password123!", "role": UserRole.STAFF, "admin": False, "department_id": departments[3]['department_id']},
        {"name": "Arjun Menon", "email": "arjun.menon.eod@kira.ai", "password": "Password123!", "role": UserRole.STAFF, "admin": False, "department_id": departments[3]['department_id']},
        {"name": "Ashraf Malik", "email": "ashraf.malik.eod@kira.ai", "password": "Password123!", "role": UserRole.STAFF, "admin": False, "department_id": departments[3]['department_id']},
        {"name": "Ava Lim", "email": "ava.lim.eod@kira.ai", "password": "Password123!", "role": UserRole.STAFF, "admin": False, "department_id": departments[3]['department_id']},
        {"name": "Ayesha Binte Ali", "email": "ayesha.ali.eod@kira.ai", "password": "Password123!", "role": UserRole.STAFF, "admin": False, "department_id": departments[3]['department_id']},
        {"name": "Azlan Rahim", "email": "azlan.rahim.eod@kira.ai", "password": "Password123!", "role": UserRole.STAFF, "admin": False, "department_id": departments[3]['department_id']},
        {"name": "Bala Krishnan", "email": "bala.krishnan.eod@kira.ai", "password": "Password123!", "role": UserRole.STAFF, "admin": False, "department_id": departments[3]['department_id']},
        {"name": "Benjamin Wong", "email": "benjamin.wong.eod@kira.ai", "password": "Password123!", "role": UserRole.STAFF, "admin": False, "department_id": departments[3]['department_id']},
        {"name": "Bernard Tan", "email": "bernard.tan.eod@kira.ai", "password": "Password123!", "role": UserRole.STAFF, "admin": False, "department_id": departments[3]['department_id']},
        {"name": "Bryan Chua", "email": "bryan.chua.eod@kira.ai", "password": "Password123!", "role": UserRole.STAFF, "admin": False, "department_id": departments[3]['department_id']},
        {"name": "Carmen Ong", "email": "carmen.ong.eod@kira.ai", "password": "Password123!", "role": UserRole.STAFF, "admin": False, "department_id": departments[3]['department_id']},
        {"name": "Cassandra Lim", "email": "cassandra.lim.eod@kira.ai", "password": "Password123!", "role": UserRole.STAFF, "admin": False, "department_id": departments[3]['department_id']},
        {"name": "Catherine Lee", "email": "catherine.lee.eod@kira.ai", "password": "Password123!", "role": UserRole.STAFF, "admin": False, "department_id": departments[3]['department_id']},
        {"name": "Chandra Raj", "email": "chandra.raj.eod@kira.ai", "password": "Password123!", "role": UserRole.STAFF, "admin": False, "department_id": departments[3]['department_id']},
        {"name": "Charles Lim", "email": "charles.lim.eod@kira.ai", "password": "Password123!", "role": UserRole.STAFF, "admin": False, "department_id": departments[3]['department_id']},
        {"name": "Cheng Wei", "email": "cheng.wei.eod@kira.ai", "password": "Password123!", "role": UserRole.STAFF, "admin": False, "department_id": departments[3]['department_id']},
        {"name": "Cheryl Tan", "email": "cheryl.tan.eod@kira.ai", "password": "Password123!", "role": UserRole.STAFF, "admin": False, "department_id": departments[3]['department_id']},
        {"name": "Christina Goh", "email": "christina.goh.eod@kira.ai", "password": "Password123!", "role": UserRole.STAFF, "admin": False, "department_id": departments[3]['department_id']},
        {"name": "Clarence Lee", "email": "clarence.lee.eod@kira.ai", "password": "Password123!", "role": UserRole.STAFF, "admin": False, "department_id": departments[3]['department_id']},
        {"name": "Clara Chia", "email": "clara.chia.eod@kira.ai", "password": "Password123!", "role": UserRole.STAFF, "admin": False, "department_id": departments[3]['department_id']},
        {"name": "Daniel Goh", "email": "daniel.goh.eod@kira.ai", "password": "Password123!", "role": UserRole.STAFF, "admin": False, "department_id": departments[3]['department_id']},
        {"name": "Daphne Lim", "email": "daphne.lim.eod@kira.ai", "password": "Password123!", "role": UserRole.STAFF, "admin": False, "department_id": departments[3]['department_id']},
        {"name": "Darren Ng", "email": "darren.ng.eod@kira.ai", "password": "Password123!", "role": UserRole.STAFF, "admin": False, "department_id": departments[3]['department_id']},
        {"name": "Debbie Yeo", "email": "debbie.yeo.eod@kira.ai", "password": "Password123!", "role": UserRole.STAFF, "admin": False, "department_id": departments[3]['department_id']},
        {"name": "Deepa Raj", "email": "deepa.raj.eod@kira.ai", "password": "Password123!", "role": UserRole.STAFF, "admin": False, "department_id": departments[3]['department_id']},
        {"name": "Diana Lim", "email": "diana.lim.eod@kira.ai", "password": "Password123!", "role": UserRole.STAFF, "admin": False, "department_id": departments[3]['department_id']},
        {"name": "Dominic Koh", "email": "dominic.koh.eod@kira.ai", "password": "Password123!", "role": UserRole.STAFF, "admin": False, "department_id": departments[3]['department_id']},
        {"name": "Durga Devi", "email": "durga.devi.eod@kira.ai", "password": "Password123!", "role": UserRole.STAFF, "admin": False, "department_id": departments[3]['department_id']},
        {"name": "Eddy Wong", "email": "eddy.wong.eod@kira.ai", "password": "Password123!", "role": UserRole.STAFF, "admin": False, "department_id": departments[3]['department_id']},
        {"name": "Elaine Yeo", "email": "elaine.yeo.eod@kira.ai", "password": "Password123!", "role": UserRole.STAFF, "admin": False, "department_id": departments[3]['department_id']},
        {"name": "Eldwin Tan", "email": "eldwin.tan.eod@kira.ai", "password": "Password123!", "role": UserRole.STAFF, "admin": False, "department_id": departments[3]['department_id']},
        {"name": "Eleanor Chua", "email": "eleanor.chua.eod@kira.ai", "password": "Password123!", "role": UserRole.STAFF, "admin": False, "department_id": departments[3]['department_id']},
        {"name": "Elizabeth Ng", "email": "elizabeth.ng.eod@kira.ai", "password": "Password123!", "role": UserRole.STAFF, "admin": False, "department_id": departments[3]['department_id']},
        {"name": "Elvin Koh", "email": "elvin.koh.eod@kira.ai", "password": "Password123!", "role": UserRole.STAFF, "admin": False, "department_id": departments[3]['department_id']},
        {"name": "Emily Tan", "email": "emily.tan.eod@kira.ai", "password": "Password123!", "role": UserRole.STAFF, "admin": False, "department_id": departments[3]['department_id']},
        {"name": "Emma Lee", "email": "emma.lee.eod@kira.ai", "password": "Password123!", "role": UserRole.STAFF, "admin": False, "department_id": departments[3]['department_id']},
        {"name": "Eunice Lim", "email": "eunice.lim.eod@kira.ai", "password": "Password123!", "role": UserRole.STAFF, "admin": False, "department_id": departments[3]['department_id']},
        {"name": "Evelyn Lau", "email": "evelyn.lau.eod@kira.ai", "password": "Password123!", "role": UserRole.STAFF, "admin": False, "department_id": departments[3]['department_id']},
        {"name": "Farhan Bin Osman", "email": "farhan.osman.eod@kira.ai", "password": "Password123!", "role": UserRole.STAFF, "admin": False, "department_id": departments[3]['department_id']},
        {"name": "Fatimah Noor", "email": "fatimah.noor.eod@kira.ai", "password": "Password123!", "role": UserRole.STAFF, "admin": False, "department_id": departments[3]['department_id']},
        {"name": "Fazli Rahman", "email": "fazli.rahman.eod@kira.ai", "password": "Password123!", "role": UserRole.STAFF, "admin": False, "department_id": departments[3]['department_id']},
        {"name": "Felix Ong", "email": "felix.ong.eod@kira.ai", "password": "Password123!", "role": UserRole.STAFF, "admin": False, "department_id": departments[3]['department_id']},
        {"name": "Fiona Tay", "email": "fiona.tay.eod@kira.ai", "password": "Password123!", "role": UserRole.STAFF, "admin": False, "department_id": departments[3]['department_id']},
    ]
    call_centre_members = []
